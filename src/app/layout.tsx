...
export const metadata: Metadata = {
  title: "Brunch Bistro - Elegant Brunch Restaurant",
  description: "Experience exceptional brunch at Brunch Bistro. Farm-to-table ingredients, artisan preparation, and welcoming atmosphere for memorable dining.",
  keywords: "brunch restaurant, farm to table, artisan food, elegant dining, breakfast, weekend brunch",
  metadataBase: new URL("https://webild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763220198131-jgkp2ce2.jpg"),
  alternates: {
    canonical: "https://webild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763220198131-jgkp2ce2.jpg"
  },
  openGraph: {
    title: "Brunch Bistro - Where Every Morning is a Celebration",
    description: "Discover exceptional brunch crafted with passion and served with elegance. Reserve your table today.",
    siteName: "Brunch Bistro",
    images: [{
      url: "https://webild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763220198131-jgkp2ce2.jpg",
      alt: "Brunch Bistro interior"
    }],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Brunch Bistro - Elegant Brunch Experience",
    description: "Farm-to-table brunch with artisan preparation and welcoming atmosphere.",
    images: ["https://webild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763220198131-jgkp2ce2.jpg"]
  },
  robots: {
    index: true,
    follow: true
